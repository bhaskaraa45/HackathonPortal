            ...
            <VStack spacing="4" width="100%">
                ...
                {teams.map((team, index) => (
                    <HStack
                        ...
                        borderColor="#1D1E37"
                    >
                        <Text noOfLines={1} fontSize="1.25rem" fontWeight="medium" ml={{ base: "24px", md: "32px" }} color="white">{team.rank}</Text>
                        <Text noOfLines={1} fontSize="1.25rem" fontWeight="medium" color="white">{team.name}</Text>
                        <Text noOfLines={1} fontSize="1.25rem" fontWeight="medium" mr={{ base: "28px", md: "36px" }} color="white">{team.currentRound}</Text>
                    </HStack>
                ))}
            </VStack>
        </Box>

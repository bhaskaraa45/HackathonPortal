...
const TeamsModal = ({ isOpen, onClose, members, name }: TeamsModalProps) => {
            ...
            <Center>
                <Modal isOpen={isOpen} onClose={onClose} isCentered>
                    ...
                    <ModalContent bg="#101232" borderRadius="md">
                        <ModalHeader ml="16px" mt="12px" textAlign="start" color="white" fontSize="2rem" fontWeight="medium">{`Team: ${name}`}</ModalHeader>

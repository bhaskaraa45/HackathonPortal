...
const CustomHead: React.FC<CustomHeadProps> = ({ title, description, keywords }) => {
    return (
        <Head>
            ...
            <meta name="description" content={description || 'Join the hackathon conducted by E-Cell IIT Hyderabad and NPCI. Showcase your skills and get chance to win exciting prizes'} />
